...
import { ButtonPrimary, ButtonSecondary, Input, RadioGroup } from '../../../../library/react';
...
class EditItem extends React.Component {
    constructor(props) {
        ...
        this.state = {
            errors: {},
            inputs: {
                altText: props.previewAttrs.snippet.title,
        ...
        return (
            <div className="youtube-edit-container">
                <div className="main-content pt-2">
                    ...
                    <div className="third-party-search-container youtube mx-4 my-4">
                        <SearchResult
                            alwaysShowPreview
                            result={previewAttrs}
                            translate={translate}
