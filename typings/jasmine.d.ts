...
declare function xit(expectation: string, assertion?: () => void): {pend?: (message?: string) => void};
declare function xit(expectation: string, assertion?: (done: () => void) => void): {pend?: (message?: string) => void};
